...
def test_m9_1_strict_verifier_accepts_complete_synthetic_public_run(tmp_path):
    ...
    for item in plan(spec):
        row = {"schema_version": "1.0", **item, **group_config(item["experiment_group"]), "result_scope": spec["result_scope"], "freeze_git_sha": "freeze", "implementation_git_sha": spec["implementation_git_sha"], "task_success": False, "final_status": "failed_official_tests"}
